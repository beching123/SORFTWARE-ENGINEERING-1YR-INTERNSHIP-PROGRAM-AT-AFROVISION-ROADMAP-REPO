...
public class RadioButtonFrame  extends JFrame {
  ...
  private final JRadioButton boldJRadioButton; // selects plain text
  ...
  public RadioButtonFrame() {
    ...
    textField = new JTextField("Wat the font style change", 25);
    ...
    radioGroup = new ButtonGroup(); // crate button
